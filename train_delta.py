...
if __name__ == "__main__":
    ...
    for l in [1e-1]:
        ...
        for e in [12]:
            for d in [8e-6, 8e-4, 8e-3, 8e-2]:
                to_run.append({"privacy":True, "model": 'CNN', "Optim": 'SGD', "lr": l, "epochs": 20, "epsilon": e, "delta": d})
    for l in [1e-3]:
        #to_run.append({"privacy":False, "model": 'CNN', "Optim": 'Adam', "lr": l, "epochs": 20})
        for e in [12]:
            for d in [8e-6, 8e-4, 8e-3, 8e-2]:
                to_run.append({"privacy":True, "model": 'CNN', "Optim": 'Adam', "lr": l, "epochs": 20, "epsilon": e, "delta": d})
